...
from privibe.cli.narrator_manager.narrator_manager_port import (
    NarratorManagerListener,
    NarratorState,
)
from privibe.cli.turn_summary import (
    NoopTurnSummary,
    TurnSummaryResult,
    TurnSummaryTracker,
    create_narrator_backend,
)
from privibe.core.audio_player.audio_player_port import AudioFormat
...
if TYPE_CHECKING:
    ...
    from privibe.cli.turn_summary import TurnSummaryPort
    from privibe.core.audio_player.audio_player_port import AudioPlayerPort
    from privibe.core.config import VibeConfig
    from privibe.core.tts.tts_client_port import TTSClientPort
    from privibe.core.types import BaseEvent
