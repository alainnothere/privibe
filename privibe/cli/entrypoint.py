...
from privibe.core.trusted_folders import has_trustable_content, trusted_folders_manager
from privibe.setup.trusted_folders.trust_folder_dialog import (
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Privibe interactive CLI")
    parser.add_argument(
...
def check_and_resolve_trusted_folder() -> None:
    try:
        ...
        rprint(
            ...
            "[yellow]The directory you started privibe from has been deleted. "
...
def main() -> None:
    ...
    from privibe.cli.cli import run_cli
