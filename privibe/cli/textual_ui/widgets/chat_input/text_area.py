...
from privibe.cli.autocompletion.base import CompletionResult
from privibe.cli.textual_ui.external_editor import ExternalEditor
from privibe.cli.textual_ui.widgets.chat_input.completion_manager import (
    MultiCompletionManager,
)
from privibe.cli.textual_ui.widgets.vscode_compat import patch_vscode_space
from privibe.cli.voice_manager.voice_manager_port import (
    RecordingStartError,
    TranscribeState,
    VoiceManagerPort,
)
