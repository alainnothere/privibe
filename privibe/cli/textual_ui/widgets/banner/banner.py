...
from privibe.cli.textual_ui.widgets.banner.petit_chat import PetitChat
...
from privibe.core.tools.mcp.registry import MCPRegistry
...
class Banner(Static):
        ...
        with Horizontal(id="banner-container"):
            ...
            with Vertical(id="banner-info"):
                with Horizontal(classes="banner-line"):
                    yield NoMarkupStatic("Privibe", id="banner-brand")
    ...
    def set_state(
        ...
        self.state = BannerState(
            ...
            if active_model_label is not None
