...
from privibe.core.paths import TRUSTED_FOLDERS_FILE
...
class TrustFolderDialog(CenterMiddle):
    ...
    def compose(self) -> ComposeResult:
        with CenterMiddle(id="trust-dialog"):
            ...
            yield NoMarkupStatic(
                "Files that can modify your Privibe setup were found here. Do you trust this folder and all its subfolders?",
