...
from privibe.core.paths.dialect import translate_path
...
class BaseTool[
    ...
    # Read-only tools stay concurrent. See AgentLoop._run_tools_concurrently.
    ...
    def get_file_snapshot_for_path(path: str) -> FileSnapshot:
        file_path = Path(translate_path(path)).expanduser()
