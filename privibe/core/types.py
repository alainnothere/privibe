...
if TYPE_CHECKING:
    from privibe.core.tools.base import BaseTool
...
class LLMUsage(BaseModel):
    ...
    # Server-reported speeds (e.g. llama.cpp timings): tokens_per_second is the
    # generation/decode rate (predicted_per_second); prompt_tokens_per_second is
    # the prompt-processing/prefill rate (prompt_per_second). Both are None when
    ...
    def __add__(self, other: LLMUsage) -> LLMUsage:
        return LLMUsage(
            ...
            tokens_per_second=(
                other.tokens_per_second
                if other.tokens_per_second is not None
                else self.tokens_per_second
            ),
            prompt_tokens_per_second=(
                other.prompt_tokens_per_second
                if other.prompt_tokens_per_second is not None
                else self.prompt_tokens_per_second
            ),
        )
