...
try:
    ...
    SDKError = BaseException  # type: ignore[misc,assignment]  # placeholder when mistralai is not installed
from pydantic import BaseModel, ConfigDict, ValidationError

from privibe.core.types import AvailableTool, LLMMessage, StrToolChoice

type HttpError = type[SDKError] | httpx.HTTPStatusError
...
class BackendErrorBuilder:
    ...
    def build_http_error(
        ...
        *,
        ...
        response = error.raw_response if SDKError is not BaseException and isinstance(error, SDKError) else error.response
