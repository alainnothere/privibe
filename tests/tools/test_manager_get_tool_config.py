...
def test_returns_default_config_when_no_overrides(tool_manager):
    ...
    )  # due to privibe's discover system isinstance would fail
...
from privibe.core.tools.base import BaseTool, BaseToolConfig, BaseToolState
...
class TestToolManagerModuleReuse:
    ...
    def test_different_files_same_stem_get_different_modules(self, tmp_path: Path):
        ...
        ~/.config/privibe/tools/ should override the builtin todo.py.
        """
        import sys
