...
from privibe.core.config import MCPHttp, MCPStdio, MCPStreamableHttp
from privibe.core.tools.mcp import (
    MCPRegistry,
    MCPToolResult,
    RemoteTool,
    _mcp_stderr_capture,
...
class TestMCPStderrCapture:
    ...
    def test_stderr_logger_thread_logs_decoded_lines(self):
        r_fd, w_fd = os.pipe()
        try:
            vibe_logger = logging.getLogger("privibe")
...
class TestMCPRegistry:
    ...
    async def test_discover_http_success(self):
        ...
        with patch(
            "privibe.core.tools.mcp.registry.list_tools_http", return_value=[remote]
        ):
    ...
    async def test_discover_http_failure_returns_none(self):
        ...
        with patch(
            "privibe.core.tools.mcp.registry.list_tools_http",
    ...
    async def test_discover_stdio_success(self):
        ...
        with patch(
            "privibe.core.tools.mcp.registry.list_tools_stdio", return_value=[remote]
        ):
    ...
    async def test_discover_stdio_failure_returns_none(self):
        ...
        with patch(
            "privibe.core.tools.mcp.registry.list_tools_stdio",
    ...
    def test_get_tools_discovers_only_uncached(self):
        ...
        with patch(
            "privibe.core.tools.mcp.registry.list_tools_http", return_value=[new_remote]
        ):
