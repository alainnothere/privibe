...
async def test_vibe_acp_initialize_and_new_session(vibe_home_dir: Path) -> None:
    ...
    try:
        ...
        assert initialize_response.agent_info.name == "privibe"
        assert initialize_response.agent_info.title == "Privibe"
...
async def test_vibe_acp_initialize_exposes_terminal_auth_when_supported(
    ...
    try:
        ...
        assert terminal_auth["label"] == "Privibe Setup"
