#!/usr/bin/env python3
"""Smoke tests for the built privibe-acp binary.
...
async def test_acp_initialize(binary: Path) -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            if resp.agent_info.name != "privibe":
...
def test_no_executable_stack(binary_dir: Path) -> None:
    ...
    candidates = [binary_dir / "privibe-acp"]
...
def main() -> None:
    ...
    binary_name = "privibe-acp.exe" if platform.system() == "Windows" else "privibe-acp"
