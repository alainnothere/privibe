...
from privibe.core.config import ModelConfig, SessionLoggingConfig
from privibe.core.types import Role
...
def acp_agent_with_session_config(
    ...
    monkeypatch.setattr("privibe.acp.acp_agent_loop.AgentLoop", PatchedAgentLoop)
