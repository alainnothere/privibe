...
from privibe.core.paths import AGENTS_MD_FILENAME, TRUSTED_FOLDERS_FILE
from privibe.core.trusted_folders import (
...
class TestHasTrustableContent:
    ...
    def test_returns_true_when_vibe_config_in_subfolder(self, tmp_path: Path) -> None:
        ...
        assert has_trustable_content(tmp_path, max_depth=1) is True
    ...
    def test_returns_true_when_agents_skills_in_subfolder(self, tmp_path: Path) -> None:
        ...
        assert has_trustable_content(tmp_path, max_depth=2) is True
