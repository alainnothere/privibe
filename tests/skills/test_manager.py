...
class TestSkillManagerSearchPaths:
    def test_discovers_from_vibe_skills_when_cwd_trusted(
        ...
        vibe_skills = tmp_working_directory / ".privibe" / "skills"
        vibe_skills.mkdir(parents=True)
        create_skill(vibe_skills, "privibe-skill", "Skill from .privibe/skills")
        ...
        assert "privibe-skill" in manager.available_skills
        assert (
            manager.available_skills["privibe-skill"].description
            == "Skill from .privibe/skills"
        )
    ...
    def test_discovers_from_both_vibe_and_agents_skills_when_cwd_trusted(
        ...
        vibe_skills.mkdir(parents=True)
        agents_skills.mkdir(parents=True)
        create_skill(vibe_skills, "privibe-only", "From .privibe")
        ...
        assert manager.available_skills["privibe-only"].description == "From .privibe"
    ...
    def test_first_discovered_wins_when_same_skill_in_vibe_and_agents(
        ...
        vibe_skills.mkdir(parents=True)
        agents_skills.mkdir(parents=True)
        create_skill(vibe_skills, "shared-skill", "First from .privibe")
        ...
        assert (
            manager.available_skills["shared-skill"].description == "First from .privibe"
        )
